...
public class ConfigUtil<T> {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        Configuration config = configUtil.readConfig("/home/satish/AppDynamics/Code/extensions/azure-servicebus-monitoring-extension/src/main/resources/config/config.yml", Configuration.class);
